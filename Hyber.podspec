#
#  Be sure to run `pod spec lint Hyber.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = {
		"Global Message Services Worldwide" => "http://www.gms-worldwide.com"
	}
  # Or just: s.author    = ""
  # s.authors            = { "" => "" }
  ...
  s.exclude_files = 'Build/**/*.*", "Pods/**/*.*", "HyberTests/**/*.*'
  ...
  s.subspec 'Core' do |core|
    ...
    inboxvc.resources = 'Resources/Inbox/**/*.*'
		inboxvc.source_files = 'Source/Inbox/**/*.{swift}'
